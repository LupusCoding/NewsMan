...
/**
 * Class ilNewsManPlugin
 * @author Ralph Dittrich <dittrich.ralph@lupuscoding.de>
 */
class ilNewsManPlugin extends ilUserInterfaceHookPlugin
{
	const PLUGIN_ID = "newsman";
	const PLUGIN_NAME = "NewsMan";
	const PLUGIN_SETTINGS = "qu_uihk_newsman";
	const PLUGIN_NS = 'LC\ILP\NewsMan';
